...
//ab me chahata hu ki ek baar mera pswd generate ho jaaye jb me pswdgen() method ko call kru to uske liye useEffect use kiya gya h
  ...
  useEffect(()=>{passwordgenerator()},[length,numberallowed,charallowed,passwordgenerator]);//but ye jo dependency lega wo whi hogi jo isse related hai aur jb bhi inme change hoga ye rerender hoga
